...
public class ServerConnector {
    ...
    public static boolean checkTimeLeft(long time) {
    ...
    public static String askServer(String path, String parameters) {
        ...
        try {
            ...
            if (e.toString().contains("429")) {
                System.out.println("Server sagt \"bitte warten\", 20 Sekunden Pause.");
                try { Thread.sleep(20000); } catch (Exception ex) {System.out.println("Sleep unterbrochen: " + ex);}
